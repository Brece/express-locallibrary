...
exports.book_create_post = [
    ...
    body('isbn', 'ISBN must not be empty')
        ...
        .escape(),
    body('genre.*').escape(),
    // (*) wildcard in the sanitizer to individually validate each of the genre array entries
...
exports.book_delete_post = (req, res, next) => {
    // First we validate that an id has been provided (this is sent via the form body parameters (HTML input name), rather than using the version in the URL).
    async.parallel(
        {
            book(callback) {
